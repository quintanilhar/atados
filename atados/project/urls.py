...
urlpatterns = patterns(
    ...
    url(_(r'^(?P<nonprofit>[-\w]+)/add-new-project/just-once$'), ProjectJustOnceCreateView.as_view(), name='new-just-once'),
    url(_(r'^(?P<nonprofit>[-\w]+)/add-new-project/periodic$'), ProjectPeriodicCreateView.as_view(), name='new-periodic'),
