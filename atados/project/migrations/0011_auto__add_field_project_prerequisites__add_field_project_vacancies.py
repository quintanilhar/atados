...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.prerequisites'
        db.add_column('project_project', 'prerequisites',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=1024),
                      keep_default=False)

        # Adding field 'Project.vacancies'
        db.add_column('project_project', 'vacancies',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.vacancies'
        db.delete_column('project_project', 'vacancies')
