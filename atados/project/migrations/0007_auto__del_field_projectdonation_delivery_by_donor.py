...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectDonation.delivery_by_donor'
        db.delete_column('project_projectdonation', 'delivery_by_donor')


    def backwards(self, orm):
        # Adding field 'ProjectDonation.delivery_by_donor'
        db.add_column('project_projectdonation', 'delivery_by_donor',
