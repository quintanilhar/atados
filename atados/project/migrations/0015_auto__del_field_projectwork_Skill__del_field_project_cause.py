...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectWork.Skill'
        db.delete_column('project_projectwork', 'Skill_id')
        ...
        # Deleting field 'Project.cause'
        db.delete_column('project_project', 'cause_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ProjectWork.Skill'
        raise RuntimeError("Cannot reverse this migration. 'ProjectWork.Skill' and its values cannot be restored.")
        # Removing M2M table for field skill on 'ProjectWork'
        db.delete_table('project_projectwork_skill')


        # User chose to not deal with backwards NULL issues for 'Project.cause'
        raise RuntimeError("Cannot reverse this migration. 'Project.cause' and its values cannot be restored.")
    ...
    models = {
        ...
        'project.project': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'vacancies': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        'project.projectwork': {
            ...
            'weekly_hours': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'project.skill': {
