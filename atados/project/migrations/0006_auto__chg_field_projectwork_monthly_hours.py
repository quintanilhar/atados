...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectWork.monthly_hours'
        db.alter_column('project_projectwork', 'monthly_hours', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ProjectWork.monthly_hours'
        db.alter_column('project_projectwork', 'monthly_hours', self.gf('django.db.models.fields.IntegerField')(default=''))
