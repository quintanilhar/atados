...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('project_project', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.deleted'
        db.add_column('project_project', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.deleted_date'
        db.add_column('project_project', 'deleted_date',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('project_project', 'published')

        # Deleting field 'Project.deleted'
        db.delete_column('project_project', 'deleted')

        # Deleting field 'Project.deleted_date'
        db.delete_column('project_project', 'deleted_date')
