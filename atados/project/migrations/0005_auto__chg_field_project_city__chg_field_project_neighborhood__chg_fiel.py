...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('project_project', 'city', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Project.neighborhood'
        db.alter_column('project_project', 'neighborhood', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Project.addressline'
        db.alter_column('project_project', 'addressline', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Project.city'
        db.alter_column('project_project', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Project.neighborhood'
        db.alter_column('project_project', 'neighborhood', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Project.addressline'
        db.alter_column('project_project', 'addressline', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
    ...
    models = {
        ...
        'project.project': {
            ...
            'addressline': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'null': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'neighborhood': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True'}),
