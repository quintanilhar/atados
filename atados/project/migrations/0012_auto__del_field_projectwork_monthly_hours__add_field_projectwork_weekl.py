...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectWork.monthly_hours'
        db.delete_column('project_projectwork', 'monthly_hours')

        # Adding field 'ProjectWork.weekly_hours'
        db.add_column('project_projectwork', 'weekly_hours',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProjectWork.monthly_hours'
        db.add_column('project_projectwork', 'monthly_hours',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ProjectWork.weekly_hours'
        db.delete_column('project_projectwork', 'weekly_hours')
